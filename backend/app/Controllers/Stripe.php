...
class Stripe extends BaseController
{
    ...
    public function createPaymentLink()
    {
        ...
        // Crear un "price" en Stripe para definir el monto
        $price = $stripe->prices->create([
            'unit_amount' => $monto,  // Multiplicamos por 100 para convertir a centavos
            'currency' => 'mxn',
            'product_data' => [
        ...
        $paymentLinkStripe = $stripe->paymentLinks->create([
            ...
            'metadata' => [
                'id' => $id, // Guardar el ID del participante
            ...
            'after_completion' => [
                'type' => 'redirect',
                'redirect' => [
                    'url' => 'https://amifit.mx/?idSocioLink=' . $id,
